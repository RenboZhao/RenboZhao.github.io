...
\noindent {\bf PhD in Operations Research} \hfill Sept.\ 2018 -- June 2023 (Expected)\\
...
Worked with Volkan Cevher on primal-dual algorithms for stochastic three-composite convex minimization with a linear operator. Paper titled ``Stochastic Three-Composite Convex Minimization with a Linear Operator'', published in {\em AISTATS}, 2018. % {\AISTATS}
...
\noindent {\bf Interests}: Cooking (Chinese and American cuisines), Sports (basketball, kayaking, cycling, table tennis), Travel, Hiking\\ \\
\noindent {\bf Computer Languages}: Python, MATLAB, R, Julia


\section*{References}
\noindent {\bf Robert M.\ Freund (Professor)}  \\
...
\noindent {\bf James Renegar (Professor)}  \\
...
\noindent {\bf Guanghui (George) Lan (Professor)}\\
...
\noindent {\bf Vamsi K.\ Potluru (AI Research Lead)}\\
...
\noindent {\bf Mohammad Fazel-Zarandi (Senior Lecturer)}\\
